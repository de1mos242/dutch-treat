...
import com.justai.jaicf.activator.dialogflow.DialogflowActivatorContext
...
class DialogflowIntentActivatorCustomImpl(
    model: ScenarioModel,
    private val connector: DialogflowConnectorCustomImpl,
    ...
    class Factory(
        ...
        override fun create(model: ScenarioModel): Activator {
            return DialogflowIntentActivatorCustomImpl(model, connector, queryParametersProvider)
        }
    }
